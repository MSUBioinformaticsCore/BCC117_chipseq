...
MOTIFDB=/mnt/research/bioinformaticsCore/shared/motif_databases/JASPAR/JASPAR2018_CORE_vertebrates_non-redundant.meme

# individual replicates. They take forever so I submitted servel different jobs to speed things up
sbatch $SRC/src/findEnrichedMotifs.sh \
  $PROJECT/results/peaks \
  $PROJECT/results \
  .nobl.narrowPeak \
  $MOTIFDB \
  $GENOME/hg19.fa.masked
```
